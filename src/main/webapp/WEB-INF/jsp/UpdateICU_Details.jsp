...
<jsp:include page="JumboTrane.jsp" />
	...
	<div class="container">
		<h3>Update ICU Patients</h3>

		<form:form method="POST" action="/updateICUDetails"
			modelAttribute="app">
			<table>
				<tr>
					<td></td>
					<td><form:hidden path="icuID" /></td>
				</tr>
				<%-- <tr>
					<td></td>
	...
	<tr>
				...
				<tr>
					<td></td>
					<td><input type="submit" value="Book A Bed" /></td>
				</tr>
			</table>
		</form:form>
	</div>
