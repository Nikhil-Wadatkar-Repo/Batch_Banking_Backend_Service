	...
	<div class="container">
		...
		<c:choose>
			...
			<c:when test="${fn:length(empList) eq 0}">
				...
				<div class="well well-lg">
					<div class="alert alert-danger" role="alert">
						<h4 class="alert-heading">Sorry!!! No Doctors are coming for
							visit.!</h4>
						<p>We dont'have any doctor's visit yet. Please click on below
							to go to doctor.</p>
						<hr>
						<p class="mb-0">
							<button type="button" class="btn btn-secondary"
								data-dismiss="modal" onClick="location.href='/Dashboard'">Dashboard</button>
						</p>
					</div>
				</div>
			...
			<c:otherwise>
				...
				<h2>Upcoming Visiting Doctors</h2>
						...
						<tbody>
							<c:forEach var="emp" items="${empList}">
								<tr>
									...
									<td>${emp.visitingDate}</td>
									<td><a href="/getVisitingDoctor/${emp.docID}">Edit</a></td>
									<td><a href="/deleteVisitingDoctor/${emp.docID}">Delete</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
